...
<body>
    ...
    <div class="notification-menu" id="notification-menu">
        ...
        @include('layaouts.notificaciones_profe')
    ...
    <div class="sidebar collapsed">
        ...
        <ul class="menu">
            <li><a href="{{ route('search.document-profesores') }}" onclick="incrementClickCount()">Busqueda</a></li>
            <li>
                <hr class="menu-separator">
            </li>
            <li><a href="{{ route('mis_documentos.document.view-Profe') }}" onclick="incrementClickCount()">Mis documentos</a></li>
            <li>
                <hr class="menu-separator">
            </li>
            <li><a href="{{ route('upload.document.view-Profe') }}" onclick="incrementClickCount()">Subir Documento</a></li>
            <li>
                <hr class="menu-separator">
            </li>
            <li><a href="{{ route('seguimiento.document.view-Profe')}}" onclick="incrementClickCount()">Seguimiento</a></li>
            <li>
                <hr class="menu-separator">
            </li>
