...
@section('content')
    ...
    <div class="container">
        @if (isset($documentos) && count($documentos) > 0)
            <h1 class="title">Asesorias a alumnado:</h1>
            <hr>
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <button class="btn btn-edit"
                                    ...
                                    <form action="{{ route('delete.document-p', ['documento_id' => $documento->Id]) }}" method="post" onsubmit="return confirmarBorrado()">
                                        @method('DELETE')
                                        @csrf
                        ...
                        <tr class="hidden-row" id="row-{{ $documento->Id }}">
                            <td colspan="4">
                                <form id="form-{{ $documento->Id }}" class="hidden-form"
                                    action="{{ route('resubirDocumento.documentMPS') }}" method="post"
