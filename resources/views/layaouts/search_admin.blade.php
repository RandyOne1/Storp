...
@section('content')
    ...
    <form action="{{ route('buscar-administrador') }}" method="GET" id="form-busqueda">
    ...
    <div class="dashboard-container" style="background-color: #fff;">
        ...
        <div id="welcome-message-container" class="welcome-message" style="z-index: -1; background-color: #fff;">
            ...
            <hr>
            <p>Por favor, utiliza la barra para buscar algun trabajo o da click a mostrar para desplegar todos los trabajos.
            </p>
        </div>
                            ...
                            <li class="glide__slide">
                                <div class="pdf-item">
                                    ...
                                    <div class="texto-medio">
                                        ...
                                        <p>Estado: <b>{{ $resultado->status }}</b></p>
                                    </div>
                                </div>
                            </li>
                        @endforeach
