                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <button class="btn btn-edit"
                                    ...
                                    <form action="{{ route('delete.document', ['documento_id' => $documento->Id]) }}" method="post" onsubmit="return confirmarBorrado()">
                                        @method('DELETE')
                                        @csrf
                        ...
                        <tr class="hidden-row" id="row-{{ $documento->Id }}">
                            <td colspan="4">
                                <form id="form-{{ $documento->Id }}" class="hidden-form"
                                    action="{{ route('resubirDocumento.document') }}" method="post"
